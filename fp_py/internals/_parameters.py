'''
    ...
    Parameters(str.replace).parameters
    # ('$self', 'old', 'new', 'count=-1')
    Parameters(str.replace).paramcount
...
# TODO: split parameters on commas first. regex is not reliable # [fixme]
_signature_regexes = {
    'self': r'\$(?P<self>self)',
...
class Parameters:
    ...
    def non_defaults(self):
        ...
        return self.self + self.positionals
